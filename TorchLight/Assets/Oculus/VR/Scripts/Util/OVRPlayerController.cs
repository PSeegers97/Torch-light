...
public class OVRPlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Q) || OVRInput.Get(OVRInput.Axis2D.PrimaryThumbstick, OVRInput.Controller.RTrackedRemote).x < 0.0f)
            buttonRotation -= RotationRatchet;

        if (Input.GetKeyDown(KeyCode.E) || OVRInput.Get(OVRInput.Axis2D.PrimaryThumbstick, OVRInput.Controller.RTrackedRemote).x > 0.0f)
            buttonRotation += RotationRatchet;
    }
    ...
    public virtual void UpdateMovement()
    {
        ...
        if (EnableRotation)
        {
            ...
            else
            {
                ...
                //{
                Vector2 altSecondaryAxis = OVRInput.Get(OVRInput.Axis2D.PrimaryThumbstick, OVRInput.Controller.RTrackedRemote);
